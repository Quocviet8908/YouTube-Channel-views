...
export const ErrorIcon: React.FC = () => (
    <svg className="h-12 w-12 text-red-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const YoutubeIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path fillRule="evenodd" d="M19.802 5.802a2.5 2.5 0 00-1.767-1.768C16.53 3.5 12 3.5 12 3.5s-4.53 0-6.035.534a2.5 2.5 0 00-1.768 1.768C3.5 7.306 3.5 12 3.5 12s0 4.694.534 6.198a2.5 2.5 0 001.768 1.767C7.47 20.5 12 20.5 12 20.5s4.53 0 6.035-.534a2.5 2.5 0 001.768-1.767c.534-1.504.534-6.198.534-6.198s0-4.694-.534-6.198zM9.54 15.58V8.42L15.72 12l-6.18 3.58z" clipRule="evenodd" />
    </svg>
);
